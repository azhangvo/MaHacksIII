...
public class FaceRecognition{
	...
	public static List<String> parseDirectory(String directoryName,String extension) throws FaceRecError{		
	...
	public MatchResult processSelections(String faceImageName,String directory,int numofFaces,String threshold) {
	...
	public static void main(String[] args){
        ...
        /*if (args.length< 4){
        	printError("Usage:  java FaceRecognition  imageName imageDir  numberOfEigenfaces threshold");
        }
		...
		MatchResult r = new FaceRecognition().processSelections(imgToCheck,imgDir,numFaces,thresholdVal);
